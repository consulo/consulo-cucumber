...
public class GrCucumberLineMarkerProvider implements LineMarkerProvider
{
	...
	public LineMarkerInfo getLineMarkerInfo(@NotNull PsiElement element)
	{
		...
		{
			return new LineMarkerInfo<>(((GrMethodCall) element), element.getTextRange().getStartOffset(), TargetAWT.to(CucumberIcons.Cucumber), Pass.UPDATE_ALL, TOOLTIP_PROVIDER, null);
		}
		else
		{
			return null;
